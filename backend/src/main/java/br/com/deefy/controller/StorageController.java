...
@Tag(name = "Storage", description = "Uploads administrativos para Supabase Storage")
...
public class StorageController {
    ...
    @Operation(summary = "Enviar audio", description = "Faz upload de audio para o bucket publico de musicas e retorna a URL.")
